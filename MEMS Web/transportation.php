    ...
    <div class="container">
        <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
            <div class="col-12 col-lg-6 col-xl-5">
                  <img src="IMAGE/bus.JPG" alt="" style="width: 80%;">
            </div>
            <div class="col-12 col-lg-6 col-xl-7">
                <div class="row justify-content-xl-center">
                    <div class="col-12 col-xl-11">
                        <h2 class="h1 mb-3" style="font-size: 40px; font-weight: 650; font-family: Georgia, 'Times New Roman', Times, serif; text-align: center;">Transportation</h2>
                        ...
                        <p class="mb-5" style="margin-top: 3px; display: flex; align-items: center; justify-content: space-between; padding: 0px 0px;font-size: 17px;font-weight: bolder;color:rgb(72, 58, 58);margin-top: .5%; text-align: justify;">
                            The institution provides ample facilities for hostel accommodation for both boys and girls. There are two separate girls hostels( one within the campus and one outside the campus) and two boys hostels likewise. The hostels are spacious, safe and secured with a cordial environment and surrounded by pleasant landscapes. The hostels have self contained two/three seater rooms which are spacious. A hygienic kitchen has been provided in each hostel with large dining halls. All the hostels have round the clock WI-FI connective and medical facility. MEMS has four hostels accommodating nearly one thousand students. Proper hygienic condition and strict supervision is maintained throughout. Several newspapers as well as magazines are subscribed and TV is also provided to get relaxed during leisure and also to get them updated.
                        </p>
