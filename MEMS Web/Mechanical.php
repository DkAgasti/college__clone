  ...
  <div class="whatsapp" style="position: fixed; bottom: 40px; right:20px">
                    ...
                    <div class="row justify-content-xl-center">
                        <div class="col-12 col-xl-11">
                            ...
                            <p class="mb-5"
                                ...
                                The department is equipped with modern laboratories to impart technical know how with state of art technology and infrastructure. It is backed by highly qualified faculty and lad demonstrators/ technicians. pic A modern lab equipped wit latest version of software of auto cad, solid works and MATLAB is available for getting acquainted with the latest trend in design and analysis of machine components and is handled by a qualified and experienced technician.
                            </p>
                        </div>
                    </div>
                </div>
	...
	padding-bottom:20px;">
        ...
        <div class="row text-center text-lg-left">
          ...
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/FMHM LAB.jpeg">
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6">
                <a href="" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" style="margin-top:25px;
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/HT LAB.jpeg">
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6">
                <a href="" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" style="margin-top:25px;
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/MOS LAB.jpg">
                </a>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-xs-6">
                <a href="" class="d-block mb-4 h-100">
                    <img class="img-fluid img-thumbnail" style="margin-top:25px;
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/RAC LAB.jpeg">
                </a>
            </div>
