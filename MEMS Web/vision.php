...
<head>
    ...
    <title>Visiin and Mission</title>
    ...
    <div class="container">
        <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
            <div class="col-12 col-lg-6 col-xl-5">
                  <img src="IMAGE/th__1_-removebg-preview.png" alt="" style="width: 80%;">
            </div>
            <div class="col-12 col-lg-6 col-xl-7">
                <div class="row justify-content-xl-center">
                    <div class="col-12 col-xl-11">
                        <h2 class="h1 mb-3" style="font-size: 40px; font-weight: 650; font-family: Georgia, 'Times New Roman', Times, serif; text-align: center;">MISSION</h2>
                        ...
                        <p class="mb-5" style="margin-top: 3px; display: flex; align-items: center; justify-content: space-between; padding: 0px 0px;font-size: 17px;font-weight: bolder;color:rgb(72, 58, 58);margin-top: .5%; text-align: justify;">
                            &bull; To produce technical leaders with global exposure to emerging frontiers of technology, industry and management so that they 
                can fit in to the latest global standards keeping pace with time. <br><br>

                 &bull; To motivate and train the youth towards the responsibility of nation building.. <br><br>
            
              &bull; To create a caring work place that fosters team work along with personal and professional growth.
                        </p>



                        <h2 class="h1 mb-3" style="font-size: 40px; font-weight: 650; font-family: Georgia, 'Times New Roman', Times, serif; text-align: center;">VISION</h2>
                         
                        <p class="mb-5" style="margin-top: 3px; display: flex; align-items: center; justify-content: space-between; padding: 0px 0px;font-size: 17px;font-weight: bolder;color:rgb(72, 58, 58);margin-top: .5%; text-align: justify;">
                            &bull; To emerge as a visionary institution and to become a dream boat for knowledge seekers in the field of technical and management education.
                        </p>
                    </div>
