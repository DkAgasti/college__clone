    ...
    <div class="container">
        <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
            <div class="col-12 col-lg-6 col-xl-5">
                  <img src="IMAGE/HOD MBA.jpg" alt="" style="width: 80%;">
            </div>
            <div class="col-12 col-lg-6 col-xl-7">
                <div class="row justify-content-xl-center">
                    <div class="col-12 col-xl-11">
                        <h1 class="h1 mb-3" style="font-size: 40px; font-weight: 650; font-family: Georgia, 'Times New Roman', Times, serif; text-align: center;">MBA</h1> <br>
                       <h2 style="font-weight: 700;">About Department :</h2> <br>
                        ...
                        <p class="mb-5" style="margin-top: 3px; display: flex; align-items: center; justify-content: space-between; padding: 0px 0px;font-size: 17px;font-weight: bolder;color:rgb(72, 58, 58);margin-top: .5%; text-align: justify;">
                            The MBA department has the motto to be an open access, student-focused teaching/training division with the capability of training students to integrate and apply knowledge from the core disciplines of management with strong, analytical and team building skills to challenge the diverse global environment. <br> <br>

The MBA department thrives to be recognized as a leading institution for management education and innovative research nationally and internationally. To be a dynamic change agent, it seeks to instill expertise in leadership and management among the students with radical ideas and reengineered knowledge for a volatile and technology driven economy.
                        </p>
    ...
    <div class="row text-center text-lg-left">
      ...
      <div class="col-lg-3 col-md-4 col-xs-6">
        <a href="" class="d-block mb-4 h-100">
          ...
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/mba1 (1).JPG">
        </a>  
      </div>
      ...
      <div class="col-lg-3 col-md-4 col-xs-6">
        <a href="" class="d-block mb-4 h-100">
          <img class="img-fluid img-thumbnail" style="margin-top:25px;
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/mba1 (2).JPG">
        </a>  
      </div>
      ...
      <div class="col-lg-3 col-md-4 col-xs-6">
        <a href="" class="d-block mb-4 h-100">
          <img class="img-fluid img-thumbnail" style="margin-top:25px;
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/mba1 (3).JPG">
        </a>  
      </div>
