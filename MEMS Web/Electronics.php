...
<nav class="navbar navbar-expand-lg navbar-dark px-5" style="background-color: darkgreen;">
  ...
  </nav> <div class="whatsapp" style="position: fixed; bottom: 40px; right:20px">
          ...
          <div class="row justify-content-xl-center">
            <div class="col-12 col-xl-11">
              <h1 class="h1 mb-3"
                ...
                Electronics & Communication Engineering</h1> <br>
              ...
              <p class="mb-5"
                ...
                The department is equipped with modern laboratories. It imparts technical know-how with state-of-art technology and infrastructure. The laboratory is one of the biggest in the college backed by highly qualified faculty and Lab-demonstrators. <br> <br>

The Analog & Digital Electronics Lab, Basic & Advanced Microprocessor Lab., Analog & Digital Signal Communication and Processing Lab, Microwave test bench including Gunn Oscillator and Television Laboratory are some of the state-of-the-art facilities, have been setup in the department.PSPICE, MATLAB and LabVIEW software help in simulating of various experimental problems.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="row text-center text-lg-left">
      ...
      <div class="col-lg-3 col-md-4 col-xs-6">
        <a href="" class="d-block mb-4 h-100">
          ...
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/DCT LAB.jpeg">
        </a>  
      </div>
      ...
      <div class="col-lg-3 col-md-4 col-xs-6">
        <a href="" class="d-block mb-4 h-100">
          <img class="img-fluid img-thumbnail" style="margin-top:25px;
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/HFE LAB.jpeg">
        </a>  
      </div>
      ...
      <div class="col-lg-3 col-md-4 col-xs-6">
        <a href="" class="d-block mb-4 h-100">
          <img class="img-fluid img-thumbnail" style="margin-top:25px;
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/AEC LAB 2.jpeg ">
        </a>  
      </div>
      ...
      <div class="col-lg-3 col-md-4 col-xs-6">
        <a href="" class="d-block mb-4 h-100">
          <img class="img-fluid img-thumbnail" style="margin-top:25px;
          box-shadow:5px 5px 5px #aaaaaa;" src="IMAGE/SIGNAL SYSTEM LAB.jpeg">
        </a>  
      </div>
