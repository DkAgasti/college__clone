    ...
    <div class="container">
        <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
            <div class="col-12 col-lg-6 col-xl-5">
                  <img src="IMAGE/hostel.jpg" alt="" style="width: 80%;">
            </div>
            <div class="col-12 col-lg-6 col-xl-7">
                <div class="row justify-content-xl-center">
                    <div class="col-12 col-xl-11">
                        <h2 class="h1 mb-3" style="font-size: 40px; font-weight: 650; font-family: Georgia, 'Times New Roman', Times, serif; text-align: center;">Hostel</h2>
