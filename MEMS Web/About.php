    ...
    <div class="container">
        <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
            <div class="col-12 col-lg-6 col-xl-5">
                  <img src="IMAGE/aboutus-removebg-preview.png" alt="" style="width: 80%;">
            </div>
            <div class="col-12 col-lg-6 col-xl-7">
                <div class="row justify-content-xl-center">
                    <div class="col-12 col-xl-11">
                        <h2 class="h1 mb-3" style="font-size: 40px; font-weight: 650; font-family: Georgia, 'Times New Roman', Times, serif; text-align: center;">ABOUT MEMS</h2>
                         
                        <p class="mb-5" style="margin-top: 3px; display: flex; align-items: center; justify-content: space-between; padding: 0px 0px;font-size: 17px;font-weight: bolder;color:rgb(72, 58, 58);margin-top: .5%; text-align: justify;">Modern Engineering & Management Studies (MEMS) has been established in the
                            year 2008 for promoting the technical education in the field of Engineering and
                            Management etc for the aspiring youth. It is built in a well planned pollution free
                            environment. It is located in Balasore, the Sand City of Orissa and the Missile Test
                            Centre of India. Built in an area of about 1,00,000 square feet of technical
                            infrastructure, it promises to provide the best possible technical education in Orissa.
                            The campus is built at Banparia on NH 5 near Kuruda, which is only 5 Km from Balasore
                            Railway Station and the Bus Stand. <br> <br>

                            The infrastructure comprises of huge air conditioned well furnished class rooms, seminar
                            halls, lecture halls, various laboratories with adequate equipments, workshop, a well
                            stocked library, continuous power backup with internet facility. The lush green campus
                            spreads over 12 acres with spacious playground, fitness center, out door sports
                            facilities, indoor games, departmental store and canteen. The well planed arboriculture
                            has added to the beauty of the campus. The Wi Fi network of the entire campus keeps the
                            people connected at all times. The nicely planned hostels and the academic ambience of
                            the campus offer an ideal environment for pursuit of a professional career.
                        </p>
                    </div>
