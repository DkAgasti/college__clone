    ...
    <div class="container">
        <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
            <div class="col-12 col-lg-6 col-xl-5">
                  <img src="IMAGE/Principal.jpg" alt="" style="width: 80%;">
            </div>
            <div class="col-12 col-lg-6 col-xl-7">
                <div class="row justify-content-xl-center">
                    <div class="col-12 col-xl-11">
                        <h2 class="h1 mb-3" style="font-size: 40px; font-weight: 650; font-family: Georgia, 'Times New Roman', Times, serif; text-align: center;">CHAIRPERSON</h2>
                         
                        <p class="mb-5" style="margin-top: 3px; display: flex; align-items: center; justify-content: space-between; padding: 0px 0px;font-size: 17px;font-weight: bolder;color:rgb(72, 58, 58);margin-top: .5%; text-align: justify;">
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Numquam ea iste fugiat exercitationem laudantium ab. At aliquam dolorem rem, ducimus odio repellat laudantium quod quia earum repellendus cupiditate sed eos expedita harum? Eum, officia necessitatibus? Officia omnis porro saepe laboriosam explicabo repudiandae earum delectus consectetur magni, aut mollitia tempore voluptatibus laudantium officiis cupiditate facilis unde maxime doloribus? Iusto qui maxime numquam odio, ipsam atque magni at ratione explicabo. Quisquam, velit veniam deleniti quam fugit nihil vitae, praesentium amet ex, rerum optio accusantium maxime qui sint. Nisi molestiae nemo ipsam aspernatur cupiditate enim quam, omnis soluta distinctio aut voluptas suscipit reprehenderit iste deleniti doloribus ratione? Totam quidem maxime debitis architecto, earum natus impedit dignissimos porro minus necessitatibus quis deserunt pariatur enim voluptatem non, mollitia assumenda officia ipsam ea hic. Excepturi error, distinctio maxime voluptatum, tempore quos corrupti alias cumque dignissimos mollitia beatae, culpa eius? Rem fugiat aliquid deleniti aut ipsam facere.
                        </p>
