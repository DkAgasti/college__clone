    ...
    <div class="container">
        <div class="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
            <div class="col-12 col-lg-6 col-xl-5">
                  <img src="IMAGE/AUDITORIOUM.jpg" alt="" style="width: 80%;">
            </div>
            <div class="col-12 col-lg-6 col-xl-7">
                <div class="row justify-content-xl-center">
                    <div class="col-12 col-xl-11">
                        <h2 class="h1 mb-3" style="font-size: 40px; font-weight: 650; font-family: Georgia, 'Times New Roman', Times, serif; text-align: center;">Seminar</h2>
                        ...
                        <p class="mb-5" style="margin-top: 3px; display: flex; align-items: center; justify-content: space-between; padding: 0px 0px;font-size: 17px;font-weight: bolder;color:rgb(72, 58, 58);margin-top: .5%; text-align: justify;">
                            MEMS has one conference hall and one seminar hall equipped with audio visual, multimedia facilities designed for conducting the seminars, workshops, orientation programmes etc. at the institute level for continuous development of students and faculty. They are well equipped to make each seminar very professional and crisp. Experts from different fields are invited to address and enlighten the students with their knowledge and experience.
                        </p>
